...
function cuentoElementos(array) {
   ...
   // Tu código:
   let cuenta = 0;
   array.forEach(element => {if(element>18){cuenta = cuenta +1}});
   return cuenta;
...
function mesesDelAño(array) {
   ...
   if(meses.includes("Enero") == false || meses.includes("Marzo") == false || meses.includes("Noviembre") == false){
...
function mayorACien(array) {
   ...
   // Tu código:
   let nuevo = [];
   array.forEach(element => {if (element >100){nuevo.push(element)}
